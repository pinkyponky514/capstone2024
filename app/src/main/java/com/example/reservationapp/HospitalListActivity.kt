...
class HospitalListActivity : AppCompatActivity() {
    ...
    private fun searchFilterAction(string: String) {
        ...
        val class1 = "발열, 고혈압, 당뇨병, 고지혈증, 소화불량, 위염, 간염, 폐렴, 천식, 갑상선, 가슴통증, 호흡곤란, 기침, 체중변화, 피로, 소화장애, 배탈" //내과
        val class2 = "충수염(맹장염), 탈장, 치질, 유방암, 갑상선암, 위암, 대장암, 간암, 췌장암, 담낭염, 종양, 혹, 출혈, 상처, 외상, 관절통, 근육통" //외과
        val class3 = "중이염, 편도염, 가래, 인후염, 비염, 부비동염(축농증), 난청, 이명, 어지럼증, 비염, 두통, 귀통증, 청력저하, 코막힘, 콧물, 인후통, 목소리변화, 어지럼증" //이비인후과
        val class4 = "여드름, 건선, 습진, 피부염, 곰팡이 감염, 바이러스 감염(사마귀, 대상포진), 탈모, 피부암, 두드러기,발진, 가려움증, 붉은 반점, 여드름, 피부 궤양, 피부 발진" //피부과
        val class5 = "결막염, 각막염, 백내장, 녹내장, 황반변성, 안구건조증, 시력 이상, 시력 저하, 눈 통증, 눈의 충혈, 눈 가려움증, 눈의 이물감, 시야에 검은 점이나 빛 번쩍임, 시력문제" //안과
        val class6 = "화상 후 재건, 선천성 기형, 미용 성형, 흉터 제거, 지방흡입, 주름 제거" //성형외과
        val class7 = "뇌종양, 뇌출혈, 뇌경색, 척추 디스크, 척추 협착증, 삼차 신경통, 말초 신경 손상" //신경외과
        val class8 = "소아 감기, 구토, 설사, 구토 및 설사, 기관지염, 식욕부진, 소아 비만, 알레르기, 예방접종" //소아청소년과
